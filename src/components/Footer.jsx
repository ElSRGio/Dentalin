          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <a href="https://wa.me/5222120275320" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition transform hover:scale-110" title="WhatsApp">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <ul className="space-y-3">
                <li className="flex gap-2">
                  ...
                  <div className="text-sm text-gray-400">
                    ...
                    <p>Huejotzolgo, Puebla</p>
                  </div>
                </li>
                <li className="flex gap-2">
                  <span>📞</span>
                  <a href="tel:+5222120275320" className="text-gray-400 hover:text-cyan-400 transition font-semibold">+52 22 1202 7532</a>
                </li>
                <li className="flex gap-2">
                  <span>📧</span>
